...
<figure class="card card-pad twin-chart"><figcaption><strong>Loss</strong><span>Lower is better</span></figcaption><svg id="twinLossChart" viewBox="0 0 520 190" role="img" aria-label="Training and validation loss"><g class="chart-grid"></g><path class="chart-line chart-train"></path><path class="chart-line chart-reference"></path><g class="chart-labels"></g></svg><div class="twin-legend"><span class="is-train">Train</span><span class="is-reference">Val</span></div></figure>
