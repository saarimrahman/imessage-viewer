...
class TwinPageTest(unittest.TestCase):
    ...
    def test_page_has_the_hooks_app_js_needs(self):
        ...
        self.assertIn('class="chart-dots"', html)
        self.assertIn('class="twin-chart-plot"', html)
        self.assertIn('class="chart-hitbox"', html)
        self.assertIn('class="trendtip twin-chart-tip"', html)
        self.assertIn('class="chart-hover"', html)
        self.assertIn('id="twinSpeedChart"', html)
